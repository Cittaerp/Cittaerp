...
namespace CittaErp.Controllers
{
    public class CompletedController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Custenq(vw_genlay glay_in, string subcheck, string headtype = "D")
        {
            pubsess = (pubsess)Session["pubsess"];
            psess = (psess)Session["psess"];
            ptype = psess.temp0.ToString();
            ...
            {
                util.update_entry("FULL", glay.vwstring0, pubsess.userid);
        ...
        private void read_recordh()
        {
            ...
            str1 = "select col3, col4, col5, col12, cast(col10 as varchar), col24, col25, col26, col27, col14, col15, col16, col2";
        ...
        private void read_cust_record()
        {
            ...
            else if (ptype == "014")
            {
                ...
                str1 += " from IV_001_PC a where contract_id= " + util.sqlquote(glay.vwstring0) + " and full_payment ='Y'";
            }
            else if (ptype == "004")
