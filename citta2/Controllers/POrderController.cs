...
namespace CittaErp.Controllers
{
    ...
    public class POrderController : Controller
    {
        ...
        AP_002_POD AP_002_POD = new AP_002_POD();
        ...
        public ActionResult EditDetails(int key1, int key2)
        {
            ...
            AP_002_POD = db.AP_002_POD.Find( qheader.intquery0, key2,0);
            if (AP_002_POD == null)
                return View(glay);
        ...
        {
            AP_002_POD = db.AP_002_POD.Find(glay.vwint0, glay.vwint1,0);
            if (AP_002_POD != null)
            {
                db.AP_002_POD.Remove(AP_002_POD);
                db.SaveChanges();
            }
        }
        ...
        private void order_update(int key1, string key2, string headtype)
        {
           ...
           // int.TryParse(salseqno, out hbug);
            ...
            {
                AP_002_POD AP_002_POD = new AP_002_POD();
                AP_002_POD.include_tax = "";
                AP_002_POD.created_by = pubsess.userid;
                AP_002_POD.created_date = DateTime.UtcNow;
                AP_002_POD.purchase_sequence_number = item.vwint0;
                AP_002_POD.line_sequence = item.vwint1;
                AP_002_POD.sub_line_sequence = item.vwint2;
                AP_002_POD.purchase_order_sequence = item.vwstring1;
                AP_002_POD.item_code = item.vwstring0;
                AP_002_POD.item_warehouse_code = "";
                AP_002_POD.vendor_code = item.vwstring4;
                AP_002_POD.order_quantity = item.vwdecimal1;
                //AP_002_POD.order_date = DateTime.UtcNow;
                AP_002_POD.delivery_quantity = 0;
                AP_002_POD.price = item.vwdecimal0;
                AP_002_POD.wht = item.vwdecimal3;
                AP_002_POD.base_amount = 0;
                AP_002_POD.extended_price = item.vwdecimal2;
                AP_002_POD.net_amount = item.vwdecimal6;
                AP_002_POD.order_amount = item.vwdecimal5;
               // AP_002_POD.actual_discount = item.vwdecimal4;
                AP_002_POD.base_amount = Convert.ToDecimal(item.vwstring2);
               // AP_002_POD.dis_flag = item.vwstring3;
                AP_002_POD.analysis_code1 = "";
                AP_002_POD.analysis_code2 = "";
                AP_002_POD.analysis_code3 = "";
                AP_002_POD.analysis_code4 = "";
                AP_002_POD.analysis_code5 = "";
                AP_002_POD.analysis_code6 = "";
                AP_002_POD.analysis_code7 = "";
                AP_002_POD.analysis_code8 = "";
                AP_002_POD.analysis_code9 = "";
                AP_002_POD.analysis_code10 = "";
                AP_002_POD.modified_date = DateTime.UtcNow;
                AP_002_POD.modified_by = pubsess.userid;

                db.Entry(AP_002_POD).State = EntityState.Added;
            ...
            if (xodr.Count > 0)
            {
                if (headtype == "with")
                {
                    ...
                    createtrans();
                    string strq = "update AP_002_POD set tax_invoiceamt1 = tax_amount1, tax_invoiceamt2 = tax_amount2, tax_amount1 = 0, tax_amount2 = 0 where purchase_sequence_number =" + qheader.intquery0.ToString() + " and item_code = 'InvoiceTax'";
        ...
        private void update_record()
        {
            ...
            else
            {
                ...
                {
                    AP_002_POD = db.AP_002_POD.Find(qheader.intquery0, glay.vwint2,0);
                }
                ...
                AP_002_POD.additional_description = "";
                AP_002_POD.purchase_sequence_number = qheader.intquery0;
                AP_002_POD.line_sequence = glay.vwint2;
                AP_002_POD.sub_line_sequence = 0;
                AP_002_POD.purchase_order_sequence = qheader.query3; // string.IsNullOrWhiteSpace(glay.vwstring7) ? "" : (glay.vwstring7);
                AP_002_POD.item_code = string.IsNullOrWhiteSpace(glay.vwstring0) ? "" : glay.vwstring0;
                AP_002_POD.vendor_code = qheader.query1;
                AP_002_POD.item_warehouse_code = string.IsNullOrWhiteSpace(glay.vwstring1) ? "" : glay.vwstring1;
                AP_002_POD.order_quantity = glay.vwdclarray0[1];
                AP_002_POD.price = glay.vwdclarray0[0];
                AP_002_POD.wht = tax;
                AP_002_POD.price_rate = decarray[8];
                AP_002_POD.delivery_quantity = decarray[ 2];
                AP_002_POD.base_amount = 0;
                AP_002_POD.extended_price = net_amt;
                AP_002_POD.net_amount = net_amt;
                AP_002_POD.order_amount = decarray[7];
                //AP_002_POD.actual_discount = 0;
                glay.vwdecimal0 = qheader.dquery0;
                AP_002_POD.base_amount = AP_002_POD.order_amount;

                //AP_002_POD.dis_flag = "N";
                AP_002_POD.include_tax = "";
                AP_002_POD.analysis_code1 = "";
                AP_002_POD.analysis_code2 = "";
                AP_002_POD.analysis_code3 = "";
                ...
                if (glay.vwstrarray6 != null)
                {
                    ...
                    if (arrlen > 0)
                        AP_002_POD.analysis_code1 = string.IsNullOrWhiteSpace(glay.vwstrarray6[0]) ? "" : glay.vwstrarray6[0];
                    if (arrlen > 1)
                        AP_002_POD.analysis_code2 = string.IsNullOrWhiteSpace(glay.vwstrarray6[1]) ? "" : glay.vwstrarray6[1];
                    if (arrlen > 2)
                        AP_002_POD.analysis_code3 = string.IsNullOrWhiteSpace(glay.vwstrarray6[2]) ? "" : glay.vwstrarray6[2];
                    if (arrlen > 3)
                        AP_002_POD.analysis_code4 = string.IsNullOrWhiteSpace(glay.vwstrarray6[3]) ? "" : glay.vwstrarray6[3];
                    if (arrlen > 4)
                        AP_002_POD.analysis_code5 = string.IsNullOrWhiteSpace(glay.vwstrarray6[4]) ? "" : glay.vwstrarray6[4];
                    if (arrlen > 5)
                        AP_002_POD.analysis_code6 = string.IsNullOrWhiteSpace(glay.vwstrarray6[5]) ? "" : glay.vwstrarray6[5];
                    if (arrlen > 6)
                        AP_002_POD.analysis_code7 = string.IsNullOrWhiteSpace(glay.vwstrarray6[6]) ? "" : glay.vwstrarray6[6];
                    if (arrlen > 7)
                        AP_002_POD.analysis_code8 = string.IsNullOrWhiteSpace(glay.vwstrarray6[7]) ? "" : glay.vwstrarray6[7];
                    if (arrlen > 8)

                        AP_002_POD.analysis_code9 = string.IsNullOrWhiteSpace(glay.vwstrarray6[8]) ? "" : glay.vwstrarray6[8];
                    if (arrlen > 9)
                        AP_002_POD.analysis_code10 = string.IsNullOrWhiteSpace(glay.vwstrarray6[9]) ? "" : glay.vwstrarray6[9];
                ...
                if (cr_flag == "CreateDetails")
                    ...
                    db.Entry(AP_002_POD).State = EntityState.Modified;
            }
      ...
      private void waredefault()
        ...
        {
            string sqlstr = "select isnull(max(line_sequence),0) vwint1 from AP_002_POD where line_sequence <> 999 and purchase_order_sequence=" + util.sqlquote(qheader.query3);
        ...
        private void createtrans()
        {
            ...
            for (int rctr = 0; rctr < recarray.GetLength(0); rctr++)
            {
                ...
                string str1 = "insert into AP_002_POD(purchase_sequence_number,line_sequence,sub_line_sequence,sales_order_sequence,item_code,order_quantity,price,extended_price,discount_percent,discount_amount,";
        ...
        public ActionResult delete_list(string id)
        {
            ...
            db.Database.ExecuteSqlCommand(sqlstr);
            sqlstr = "delete from [dbo].[AP_002_POD] where cast(purchase_sequence_number as varchar)=" + util.sqlquote(id);
            db.Database.ExecuteSqlCommand(sqlstr);
            return RedirectToAction("Index");
        }
        ...
        public ActionResult delete_detail(string id)
        {
            // write your query statement
            qheader = (queryhead)Session["qheader"];
            string sqlstr = "delete from [dbo].[AP_002_POD] where cast(purchase_sequence_number as varchar) +'[]'+ cast(line_sequence as varchar) =" + util.sqlquote(id);
            db.Database.ExecuteSqlCommand(sqlstr);
            sqlstr = "select count(0) intquery0 from AP_002_POD where dis_flag='N' and purchase_sequence_number=" + qheader.intquery0.ToString();
            var delctr = db.Database.SqlQuery<querylay>(sqlstr).FirstOrDefault();
            if (delctr.intquery0==0)
            {
                sqlstr = "delete from AP_002_POD where purchase_sequence_number=" + qheader.intquery0.ToString();
                db.Database.ExecuteSqlCommand(sqlstr);
        ...
        private void call_discount()
        {
            ...
            //string str = " delete AP_002_POD where purchase_sequence_number =" + qheader.intquery0.ToString() + "and dis_flag = 'I'";
            //db.Database.ExecuteSqlCommand(str);
        ...
        private void move_detail()
        {
            ...
            var bgdtl = (from bh in db.IV_001_ITEM
                         ...
                         into bf1
                         from bf2 in bf1.DefaultIfEmpty()
                         where bh.item_code == AP_002_POD.item_code
                         select new { bh, bf2 }).FirstOrDefault();


            glay.vwint2 = AP_002_POD.line_sequence;
            glay.vwstring7 = AP_002_POD.purchase_order_sequence;
            glay.vwstring0 = AP_002_POD.item_code;
            glay.vwdclarray0[0] = AP_002_POD.price;
            glay.vwdecimal4 = (AP_002_POD.price * exc_rt);
            glay.vwdclarray0[1] = AP_002_POD.order_quantity;
            glay.vwdecimal2 = (AP_002_POD.extended_price * exc_rt);
            //glay.vwdclarray0[2] = (AP_002_POD.discount_amount * exc_rt); ;
           // glay.vwdclarray0[3] = AP_002_POD.discount_percent;
            glay.vwdclarray0[4] = (AP_002_POD.net_amount * exc_rt); ;
            glay.vwdecimal1 = (AP_002_POD.wht * exc_rt); ;
            glay.vwdecimal3 = AP_002_POD.base_amount;
            //glay.vwdecimal5 = (AP_002_POD.actual_discount * exc_rt); ;
            glay.vwdclarray0[5] = (AP_002_POD.order_amount * exc_rt); ;
            glay.vwstrarray6[0] = AP_002_POD.analysis_code1;
            glay.vwstrarray6[1] = AP_002_POD.analysis_code2;
            glay.vwstrarray6[2] = AP_002_POD.analysis_code3;
            glay.vwstrarray6[3] = AP_002_POD.analysis_code4;
            glay.vwstrarray6[4] = AP_002_POD.analysis_code5;
            glay.vwstrarray6[5] = AP_002_POD.analysis_code6;
            glay.vwstrarray6[6] = AP_002_POD.analysis_code7;
            glay.vwstrarray6[7] = AP_002_POD.analysis_code8;
            glay.vwstrarray6[8] = AP_002_POD.analysis_code9;
            glay.vwstrarray6[9] = AP_002_POD.analysis_code10;
        ...
        {
            string sqlstr = " update AP_002_PURHEAD set order_total_amount = a001, order_total_tax = a002, order_total_discount = 0, order_total_extended_price = a004 from AP_002_PURHEAD ax, ";
            sqlstr += " (select sum(order_amount) a001, sum(tax_amount) a002, sum(extended_price) a004, sum(order_quantity) as a005 from AP_002_POD where  purchase_order_sequence=" + util.sqlquote(qheader.query3);
