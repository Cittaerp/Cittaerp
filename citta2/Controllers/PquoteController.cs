...
namespace CittaErp.Controllers
{
    ...
    public class PquoteController : Controller
    {
        //
        // GET: /Employee/

        AP_002_QUOTE AP_002_QUOTE = new AP_002_QUOTE();
          ...
          //  Session["curren_name"] = "";
            ...
            var bglist = from bh in db.AP_002_PURHEAD
                        ...
                        on new { a2 = bh.vendor_code } equals new { a2 = bg1.vendor_code }
                         ...
                         where bh.status == 02 && bh.approval_level==0
                         select new vw_genlay
                         {
                             ...
                             vwstring3 = bh.purchase_quote_date,
                             vwstring4 = bh.purchase_quote_expiration_date,
        ...
        public ActionResult EditDetails(int key1, int key2)
        {
            ...
            AP_002_QUOTE = db.AP_002_QUOTE.Find( qheader.intquery0, key2,0);
            if (AP_002_QUOTE == null)
                return View(glay);
        ...
        {
            AP_002_QUOTE = db.AP_002_QUOTE.Find(glay.vwint0, glay.vwint1,0);
            if (AP_002_QUOTE != null)
            {
                db.AP_002_QUOTE.Remove(AP_002_QUOTE);
                db.SaveChanges();
            }
        }
        ...
        private void order_update(int key1, string key2, string headtype)
        {
            ...
            str1 += " quote_date vwstring0, quote_expiration_date vwstring1 from AP_002_PURHEAD where quote_reference=" + util.sqlquote(key2);
            var str2 = db.Database.SqlQuery<vw_genlay>(str1).FirstOrDefault();

            string str = "update AP_002_PURHEAD set quote_reference=" + util.sqlquote(key2) + ",  order_reference="+ util.sqlquote(preseq)+", order_total_ext_price=" + str2.vwdecimal0 + ", order_total_inv_tax =";
            str += +str2.vwdecimal1 + ", order_total_discount=" + str2.vwdecimal2 + ", order_total_tax=" + str2.vwdecimal3 + ", order_total_amount=";
            str += +str2.vwdecimal4 + ", order_total_qty=" + str2.vwdecimal5 + ", order_date=" + str2.vwstring0 + ", order_expiration_date=" + str2.vwstring1 + ", approval_level=0, status=02 where quote_reference=" + util.sqlquote(key2);
            db.Database.ExecuteSqlCommand(str);
           ...
           // int.TryParse(salseqno, out hbug);
            var bglist = from bh in db.AR_002_QUOTE
                         ...
                         select new vw_genlay
                         {
                             ...
                             vwstring3 = bh.dis_flag,
                             vwstring4 = bh.customer_code
                         };
            var xodr = bglist.ToList();
            foreach (var item in xodr)
            {
                AP_002_QUOTE AP_002_QUOTE = new AP_002_QUOTE();
                //AP_002_QUOTE.include_tax = "";
                AP_002_QUOTE.created_by = pubsess.userid;
                AP_002_QUOTE.created_date = DateTime.UtcNow;
                AP_002_QUOTE.purchase_sequence_number = item.vwint0;
                AP_002_QUOTE.line_sequence = item.vwint1;
                AP_002_QUOTE.sub_line_sequence = item.vwint2;
                AP_002_QUOTE.purchase_quote_sequence = item.vwstring1;
                AP_002_QUOTE.item_code = item.vwstring0;
                //AP_002_QUOTE.item_warehouse_code = "";
                AP_002_QUOTE.vendor_code = item.vwstring4;
                AP_002_QUOTE.purchase_quote_qty = item.vwdecimal1;
                //AP_002_QUOTE.order_date = DateTime.UtcNow;
               // AP_002_QUOTE.delivery_quantity = 0;
                AP_002_QUOTE.price = item.vwdecimal0;
                AP_002_QUOTE.wht = item.vwdecimal3;
                AP_002_QUOTE.base_amount = 0;
                AP_002_QUOTE.ext_price = item.vwdecimal2;
                AP_002_QUOTE.net_amount = item.vwdecimal6;
                AP_002_QUOTE.quote_amount = item.vwdecimal5;
               // AP_002_QUOTE.actual_discount = item.vwdecimal4;
                AP_002_QUOTE.base_amount = Convert.ToDecimal(item.vwstring2);
               // AP_002_QUOTE.dis_flag = item.vwstring3;
                AP_002_QUOTE.analysis_code1 = "";
                AP_002_QUOTE.analysis_code2 = "";
                AP_002_QUOTE.analysis_code3 = "";
                AP_002_QUOTE.analysis_code4 = "";
                AP_002_QUOTE.analysis_code5 = "";
                AP_002_QUOTE.analysis_code6 = "";
                AP_002_QUOTE.analysis_code7 = "";
                AP_002_QUOTE.analysis_code8 = "";
                AP_002_QUOTE.analysis_code9 = "";
                AP_002_QUOTE.analysis_code10 = "";
                AP_002_QUOTE.modified_date = DateTime.UtcNow;
                AP_002_QUOTE.modified_by = pubsess.userid;

                db.Entry(AP_002_QUOTE).State = EntityState.Added;
            ...
            if (xodr.Count > 0)
            {
                if (headtype == "with")
                {
                    ...
                    createtrans();
                    string strq = "update AP_002_QUOTE set tax_invoiceamt1 = tax_amount1, tax_invoiceamt2 = tax_amount2, tax_amount1 = 0, tax_amount2 = 0 where purchase_sequence_number =" + qheader.intquery0.ToString() + " and item_code = 'InvoiceTax'";
        ...
        private void update_record()
        {
            ...
            if (cr_flag.IndexOf("Header") > 0)
            {
                ...
                gdoc.purchase_quote_expiration_date = expdate.ToString("yyyyMMdd");
                gdoc.purchase_quote_date = util.date_yyyymmdd(glay.vwstrarray0[4]);
            ...
            else
            {
                ...
                {
                    AP_002_QUOTE = db.AP_002_QUOTE.Find(qheader.intquery0, glay.vwint2,0);
                }
                ...
                AP_002_QUOTE.additional_description = "";
                AP_002_QUOTE.purchase_sequence_number = qheader.intquery0;
                AP_002_QUOTE.line_sequence = glay.vwint2;
                AP_002_QUOTE.sub_line_sequence = 0;
                AP_002_QUOTE.purchase_quote_sequence = qheader.query3; // string.IsNullOrWhiteSpace(glay.vwstring7) ? "" : (glay.vwstring7);
                AP_002_QUOTE.item_code = string.IsNullOrWhiteSpace(glay.vwstring0) ? "" : glay.vwstring0;
                AP_002_QUOTE.vendor_code = qheader.query1;
               // AP_002_QUOTE.item_warehouse_code = string.IsNullOrWhiteSpace(glay.vwstring1) ? "" : glay.vwstring1;
                AP_002_QUOTE.purchase_quote_qty = glay.vwdclarray0[1];
                AP_002_QUOTE.price = glay.vwdclarray0[0];
                AP_002_QUOTE.wht = tax;
                AP_002_QUOTE.price_rate = decarray[8];
               // AP_002_QUOTE.delivery_quantity = decarray[ 2];
                AP_002_QUOTE.base_amount = 0;
                AP_002_QUOTE.ext_price = net_amt;
                AP_002_QUOTE.net_amount = net_amt;
                AP_002_QUOTE.quote_amount = decarray[7];
                //AP_002_QUOTE.actual_discount = 0;
                glay.vwdecimal0 = qheader.dquery0;
                AP_002_QUOTE.base_amount = AP_002_QUOTE.quote_amount;

                //AP_002_QUOTE.dis_flag = "N";
                //AP_002_QUOTE.include_tax = "";
                AP_002_QUOTE.analysis_code1 = "";
                AP_002_QUOTE.analysis_code2 = "";
                AP_002_QUOTE.analysis_code3 = "";
                ...
                if (glay.vwstrarray6 != null)
                {
                    ...
                    if (arrlen > 0)
                        AP_002_QUOTE.analysis_code1 = string.IsNullOrWhiteSpace(glay.vwstrarray6[0]) ? "" : glay.vwstrarray6[0];
                    if (arrlen > 1)
                        AP_002_QUOTE.analysis_code2 = string.IsNullOrWhiteSpace(glay.vwstrarray6[1]) ? "" : glay.vwstrarray6[1];
                    if (arrlen > 2)
                        AP_002_QUOTE.analysis_code3 = string.IsNullOrWhiteSpace(glay.vwstrarray6[2]) ? "" : glay.vwstrarray6[2];
                    if (arrlen > 3)
                        AP_002_QUOTE.analysis_code4 = string.IsNullOrWhiteSpace(glay.vwstrarray6[3]) ? "" : glay.vwstrarray6[3];
                    if (arrlen > 4)
                        AP_002_QUOTE.analysis_code5 = string.IsNullOrWhiteSpace(glay.vwstrarray6[4]) ? "" : glay.vwstrarray6[4];
                    if (arrlen > 5)
                        AP_002_QUOTE.analysis_code6 = string.IsNullOrWhiteSpace(glay.vwstrarray6[5]) ? "" : glay.vwstrarray6[5];
                    if (arrlen > 6)
                        AP_002_QUOTE.analysis_code7 = string.IsNullOrWhiteSpace(glay.vwstrarray6[6]) ? "" : glay.vwstrarray6[6];
                    if (arrlen > 7)
                        AP_002_QUOTE.analysis_code8 = string.IsNullOrWhiteSpace(glay.vwstrarray6[7]) ? "" : glay.vwstrarray6[7];
                    if (arrlen > 8)

                        AP_002_QUOTE.analysis_code9 = string.IsNullOrWhiteSpace(glay.vwstrarray6[8]) ? "" : glay.vwstrarray6[8];
                    if (arrlen > 9)
                        AP_002_QUOTE.analysis_code10 = string.IsNullOrWhiteSpace(glay.vwstrarray6[9]) ? "" : glay.vwstrarray6[9];
                ...
                if (cr_flag == "CreateDetails")
                    ...
                    db.Entry(AP_002_QUOTE).State = EntityState.Modified;
            }
            ...
            if (err_flag && cr_flag.IndexOf("Header") > 0)
            {
                {
                    set_qheader();
                    util.write_document("PUROR", gdoc.purchase_sequence_number.ToString(), photo1, glay.vwstrarray9);
                }
      ...
      private void waredefault()
        ...
        {
            string sqlstr = "select isnull(max(line_sequence),0) vwint1 from AP_002_QUOTE where line_sequence <> 999 and purchase_order_sequence=" + util.sqlquote(qheader.query3);
        ...
        private void createtrans()
        {
            ...
            for (int rctr = 0; rctr < recarray.GetLength(0); rctr++)
            {
                ...
                string str1 = "insert into AP_002_QUOTE(purchase_sequence_number,line_sequence,sub_line_sequence,sales_order_sequence,item_code,order_quantity,price,extended_price,discount_percent,discount_amount,";
        ...
        public ActionResult delete_list(string id)
        {
            ...
            db.Database.ExecuteSqlCommand(sqlstr);
            sqlstr = "delete from [dbo].[AP_002_QUOTE] where cast(purchase_sequence_number as varchar)=" + util.sqlquote(id);
            db.Database.ExecuteSqlCommand(sqlstr);
            return RedirectToAction("Index");
        }
        ...
        public ActionResult delete_detail(string id)
        {
            // write your query statement
            qheader = (queryhead)Session["qheader"];
            string sqlstr = "delete from [dbo].[AP_002_QUOTE] where cast(purchase_sequence_number as varchar) +'[]'+ cast(line_sequence as varchar) =" + util.sqlquote(id);
            db.Database.ExecuteSqlCommand(sqlstr);
            sqlstr = "select count(0) intquery0 from AP_002_QUOTE where dis_flag='N' and purchase_sequence_number=" + qheader.intquery0.ToString();
            var delctr = db.Database.SqlQuery<querylay>(sqlstr).FirstOrDefault();
            if (delctr.intquery0==0)
            {
                sqlstr = "delete from AP_002_QUOTE where purchase_sequence_number=" + qheader.intquery0.ToString();
                db.Database.ExecuteSqlCommand(sqlstr);
                sqlstr = "update AP_002_PURHEAD set order_total_qty=0,order_total_ext_price=0,order_total_discount=0, order_total_inv_tax=0,order_total_tax=0,order_total_amount=0 "; 
        ...
        private void read_details()
        {
            ...
            var bglist = from bh in db.AP_002_QUOTE
        ...
        private void call_discount()
        {
            ...
            //string str = " delete AP_002_QUOTE where purchase_sequence_number =" + qheader.intquery0.ToString() + "and dis_flag = 'I'";
            //db.Database.ExecuteSqlCommand(str);
        ...
        private void move_detail()
        {
            ...
            var bgdtl = (from bh in db.IV_001_ITEM
                         ...
                         into bf1
                         from bf2 in bf1.DefaultIfEmpty()
                         where bh.item_code == AP_002_QUOTE.item_code
                         select new { bh, bf2 }).FirstOrDefault();


            glay.vwint2 = AP_002_QUOTE.line_sequence;
            glay.vwstring7 = AP_002_QUOTE.purchase_quote_sequence;
            glay.vwstring0 = AP_002_QUOTE.item_code;
            glay.vwdclarray0[0] = AP_002_QUOTE.price;
            glay.vwdecimal4 = (AP_002_QUOTE.price * exc_rt);
            glay.vwdclarray0[1] = AP_002_QUOTE.purchase_quote_qty;
            glay.vwdecimal2 = (AP_002_QUOTE.ext_price * exc_rt);
            //glay.vwdclarray0[2] = (AP_002_QUOTE.discount_amount * exc_rt); ;
           // glay.vwdclarray0[3] = AP_002_QUOTE.discount_percent;
            glay.vwdclarray0[4] = (AP_002_QUOTE.net_amount * exc_rt); ;
            glay.vwdecimal1 = (AP_002_QUOTE.wht * exc_rt); ;
            glay.vwdecimal3 = AP_002_QUOTE.base_amount;
            //glay.vwdecimal5 = (AP_002_QUOTE.actual_discount * exc_rt); ;
            glay.vwdclarray0[5] = (AP_002_QUOTE.quote_amount * exc_rt); ;
            glay.vwstrarray6[0] = AP_002_QUOTE.analysis_code1;
            glay.vwstrarray6[1] = AP_002_QUOTE.analysis_code2;
            glay.vwstrarray6[2] = AP_002_QUOTE.analysis_code3;
            glay.vwstrarray6[3] = AP_002_QUOTE.analysis_code4;
            glay.vwstrarray6[4] = AP_002_QUOTE.analysis_code5;
            glay.vwstrarray6[5] = AP_002_QUOTE.analysis_code6;
            glay.vwstrarray6[6] = AP_002_QUOTE.analysis_code7;
            glay.vwstrarray6[7] = AP_002_QUOTE.analysis_code8;
            glay.vwstrarray6[8] = AP_002_QUOTE.analysis_code9;
            glay.vwstrarray6[9] = AP_002_QUOTE.analysis_code10;
        ...
        {
            string sqlstr = " update AP_002_PURHEAD set quote_total_amount = a001, quote_total_tax = a002, quote_total_discount = 0, quote_total_extended_price = a004 from AP_002_PURHEAD ax, ";
            sqlstr += " (select sum(quote_amount) a001, sum(tax_amount) a002, sum(ext_price) a004, sum(purchase_quote_qty) as a005 from AP_002_QUOTE where  purchase_quote_sequence=" + util.sqlquote(qheader.query3);
