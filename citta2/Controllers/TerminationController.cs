...
namespace CittaErp.Controllers
{
    public class TerminationController : Controller
    {
        ...
        //{
        //    var empe = from pf in db.IV_002_PAY
        ...
        private void read_recordh()
        {
            ...
            string str1 = "select col1, col2, col3, col4, col24, col25, col26";
            str1 += "  from  [" + pubsess.userid + "fpay] where colid="+ util.sqlquote(glay.vwstring0);
           ...
           // int jnum = 0;
            ...
            var bglist = from bh in db.GL_002_JONAD
                         ...
                         select new vw_genlay
                         {
                             ...
                             vwstring7 = bh.account_type_debit == "003" ? bk2.account_name : bh.account_type_debit == "001" ? bl2.cust_biz_name : bh.account_type_debit == "003" ? bm2.vend_biz_name : bh.account_type_debit == "004" ? bn2.bank_name : bo2.description,
                             ...
                             vwstring0 = bh.account_type_debit == "003" ? bk2.account_code : bh.account_type_debit == "001" ? bl2.customer_code : bh.account_type_debit == "003" ? bm2.vendor_code : bh.account_type_debit == "004" ? bn2.bank_code : bo2.consignment_code,
