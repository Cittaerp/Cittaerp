...
namespace CittaErp.ReportA
{
    ...
    public partial class Sreport1 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void Sreport1_ReportStart(object sender, EventArgs e)
        {
            ...
            psess = (psess)HttpContext.Current.Session["psess"];
            string query = "select  * from [" + pblock.userid + "st01] order by " + orderbyt + " record_counter";
        ...
        private void main01()
        {
            ...
            string str4 = "select field1 c1,field2 c2,field9 c3, field10 c4,field5 c5, field6 c6,field11 c7 from GB_001_COY where id_code='COYREPORT'";
            var str5 = db.Database.SqlQuery<vw_query>(str4).FirstOrDefault();
            ...
            if (psess.sarrayt1 == null)
                psess.sarrayt1 = new string[] { "N", "N", "N", "N", "N", "N", "N", "N", "N", "N", "", "", "N", "N", "N", "N", "N","1" };
            //else
            //    rpt_value = psess.sarrayt1;

            string lineg = psess.sarrayt1[17];
...
// read printer to get font and size
            if (psess.sarrayt1[11] != "")
            {
                str4 = "select report_name c0 from tab_calc where calc_code='" + psess.sarrayt1[11] + "' and para_code='" + HttpContext.Current.Session["adv1"].ToString() + "' ";
            ...
            if (psess.sarrayt1[10] != "")
            {
                this.pperiod.Text = "Payroll Period : " + psess.sarrayt1[10];
...
//numeric figures
        ...
        private void header_checker()
        {
            ...
            if (psess.sarrayt1[0] == "Y" || psess.sarrayt1[5] == "Y" || psess.sarrayt1[12] == "Y")
            {
                recpos = 0.07f;
            ...
            if (psess.sarrayt1[1] == "Y" || psess.sarrayt1[6] == "Y" || psess.sarrayt1[13] == "Y")
            {
                recpos = 0.07f ;
            ...
            if (psess.sarrayt1[2] == "Y" || psess.sarrayt1[7] == "Y" || psess.sarrayt1[14] == "Y")
            {
                recpos = 0.07f ;
            ...
            if (psess.sarrayt1[3] == "Y" || psess.sarrayt1[8] == "Y" || psess.sarrayt1[15] == "Y")
            {
                recpos = 0.07f ;
            ...
            if (psess.sarrayt1[4] == "Y" || psess.sarrayt1[9] == "Y" || psess.sarrayt1[16] == "Y")
            {
                recpos = 0.07f ;
